  ...
  <div class="bg-primary">
    <div class="max-w-[1170px] mx-auto px-6 py-20 mt-16 grid md:grid-cols-2 gap-5">
        ...
        <div class="text-white">
          ...
          <h3 style="font-weight: 700;" class="sm:text-[28px] text-[24px] tracking-wide font-oswald text-center">{{ bannerSectionData.REGPRICE }} - <span class="line-through">{{ bannerSectionData.REGPRICEVALUE }}</span></h3>
          <h3 style="font-weight: 700;" class="sm:text-[32px] text-[28px] tracking-wide font-oswald text-center mt-3">{{ bannerSectionData.TODAYOFFER }}</h3>
