<template>
  <div class="bg-primary">
    <div class="max-w-[1170px] mx-auto px-6 py-20 mt-16 grid md:grid-cols-2 gap-5">
        <div>
        ...
        <div class="text-white">
          <h2 class="xl:text-4xl md:text-2xl font-bold">{{ bannerSectionData.HEADLINE }}</h2> 
          <p class="my-4 xl:text-xl md:text-sm py-4 tracking-wider border-b border-t">{{ bannerSectionData.DESCRIPTION }}</p>

          <h3 style="font-weight: 700;" class="md:text-[28px] font-oswald text-center">{{ bannerSectionData.REGPRICE }} - <span class="line-through">{{ bannerSectionData.REGPRICEVALUE }}</span></h3>
          <h3 style="font-weight: 700;" class="md:text-[32px] font-oswald text-center mt-3">{{ bannerSectionData.TODAYOFFER }}</h3>
